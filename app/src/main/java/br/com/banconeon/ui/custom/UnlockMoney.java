package br.com.banconeon.ui.custom;
...
public class UnlockMoney extends RelativeLayout {
    ...
    public UnlockMoney(Context context) {
        super(context);
        init(context, null);
    }

    public UnlockMoney(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public UnlockMoney(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void reset() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                params.leftMargin = (Integer) valueAnimator.getAnimatedValue() - 16;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.unlock_money, this, true);
